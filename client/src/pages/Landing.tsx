    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button asChild size="sm" data-testid="button-register">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="inline-block">
              <img src="/logo.png" alt="TecDrive" className="h-20 w-20 mx-auto mb-6" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button asChild size="lg" className="text-base" data-testid="button-hero-start">
                <a href="/api/login">Comenzar ahora</a>
              </Button>
              <Button asChild size="lg" variant="outline" className="text-base" data-testid="button-hero-plans">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center space-y-4">
              <h2 className="text-3xl sm:text-4xl font-bold" data-testid="text-story-title">
                ¿Qué es TecDrive?
              </h2>
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <Button asChild size="lg" variant="secondary" className="text-base" data-testid="button-cta-register">
